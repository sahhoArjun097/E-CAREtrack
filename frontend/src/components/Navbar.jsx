        ...
        <div className="   md:absolute flex  w-screen  items-center justify-between px-8 py-3 h-[60px] ">
            ...
            <div className={`navLinks ${show ? "flex" : "hidden"} md:flex md:items-center`}>
                <div className="flex font-semibold flex-col md:flex-row md:gap-9">
                    <Link to="/" className="hover:text-blue-300 transition duration-300" onClick={() => setShow(!show)}>
                        HOME
                    </Link>
                    <Link to="/aboutus" className="hover:text-blue-300 transition duration-300">
                        ABOUT US
                    </Link>
                    <Link to="/appointments" className="hover:text-blue-300 transition duration-300">
                        APPOINTMENTS
                    </Link>
                </div>
            </div>
